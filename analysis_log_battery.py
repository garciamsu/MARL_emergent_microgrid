...
def analyze_batteryagent():
    # Input and output paths
    input_path = "results/logs/batteryagent/batteryagent_log.csv"
    output_dir = "results/logs/batteryagent/"
    ...
    plt.title("Reward Distribution by Action - Battery Agent")
    plt.ylabel("Reward")
    ...
    plt.title(f"Rolling Mean of Reward (window = {window} steps) - Battery Agent")
    plt.xlabel("Step")
    ...
    plt.title("Action Frequency of Battery Agent")
    plt.xlabel("Action")
    plt.ylabel("Count")
    ...
    print("\n✅ Battery agent log analysis completed.")


if __name__ == "__main__":
    analyze_batteryagent()
